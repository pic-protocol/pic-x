...
mod tests {
    ...
    fn test_render_full_contains_the_ascii_art_and_metadata() {
        ...
        assert!(rendered.contains("Demo X (Demonstration Exchange)"));
        assert!(rendered.contains("A Demonstrated Tagline"));
        assert!(rendered.contains("Version 9.9.9"));
        assert!(rendered.contains("© 2026 Test Holder. All rights reserved."));
    }
    ...
    fn test_render_short_omits_the_ascii_art() {
        ...
        assert!(rendered.starts_with("Demo X (Demonstration Exchange)"));
        assert!(rendered.contains("A Demonstrated Tagline"));
        assert!(rendered.contains("Version 9.9.9"));
        assert!(rendered.contains("© 2026 Test Holder."));
    }
