...
//! nothing else here. A crate that implements one of these contracts depends on `pic-x-core` and
...
//!
//! ```toml
//! pic-x-std = { version = "0.1", default-features = false, features = ["secrets", "storage"] }
//! ```
//!
